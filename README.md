...
| The first  $`\hat{x_{0}}`$ prediction made after only 2000 small batches of training. Notice the faint purples on the wall recovered even from the extreme haze.
